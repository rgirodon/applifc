...
@section('header')
	...
	<h1>
		{{ $club->name }} - Entrainement  à venir
		...
		<table class="table table-striped table-hover">
			...
			@foreach ($entrainements as $entrainement)
				...
				<tr>
					...
					<td>{!! nl2br($entrainement->comments) !!}</<td>
					...
					@auth
						...
						<td>
							...
							<form id="deleteConvocationForm_{{ $entrainement->id }}" action="{{ route('entrainement.delete', $entrainement->id) }}" method="post">
